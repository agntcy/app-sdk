...
This document outlines security procedures and general policies for the `app-sdk` project.
...
The `app-sdk` maintainers take all security issues in the project
seriously. Thank you for improving the security of `app-sdk`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`app-sdk` leverages GitHub's private vulnerability reporting.
